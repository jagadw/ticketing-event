<div class="space-y-6">
    <section class="rounded-[2rem] border border-slate-200/80 bg-white/85 p-6 shadow-[0_12px_30px_rgba(15,23,42,0.04)] backdrop-blur">
        <div class="flex items-start justify-between gap-4 mb-6">
            <div>
                <p class="text-xs font-semibold uppercase tracking-[0.22em] text-slate-500">Create Promo</p>
                <h3 class="mt-1 text-2xl font-semibold text-slate-950">Tambah promo baru</h3>
            </div>
        ...
        <form wire:submit.prevent="savePromo" class="space-y-4">
            <div>
                ...
                <input wire:model="form.promo_code" type="text" class="w-full rounded-2xl border border-slate-200 bg-slate-50 px-4 py-3 text-sm outline-none transition focus:border-slate-400 focus:bg-white" placeholder="Contoh: DISKON50">
            ...
            <div>
                ...
                <input wire:model="form.discount_percentage" type="number" min="0" max="100" step="1" class="w-full rounded-2xl border border-slate-200 bg-slate-50 px-4 py-3 text-sm outline-none transition focus:border-slate-400 focus:bg-white" placeholder="Contoh: 25">
